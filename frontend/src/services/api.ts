...
const documents: Document[] = [
    {
        ...
        words: 1248,
        favorite: true,
        excerpt: "A focused plan for introducing the next generation of our product.",
    },
    {
        id: "2",
        ...
        words: 642,
        favorite: true,
        excerpt: "A warm, clear onboarding experience for new customers.",
    },
    {
        id: "3",
        ...
        words: 1830,
        excerpt: "Distributed teams are reshaping the way meaningful work gets done.",
    },
    {
        id: "4",
        ...
        words: 478,
        excerpt: "A concise recap of this month’s progress and priorities.",
    },
];
...
/**
 * Temporary data source for frontend features without backend endpoints.
 * Keep real API calls in feature-specific services, such as letterService.
 */
